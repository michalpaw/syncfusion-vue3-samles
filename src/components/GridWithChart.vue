      ...
      <ejs-grid ref='gridInstance' id='GridChart' :dataSource='data' :height="500" gridLines='Both'
        ...
        <template v-slot:productTemplate="{ data }">
          <div class="e-product-info">
            <img :src="'https://ej2.syncfusion.com/vue/demos/src/grid/images/product/' + data.Image + '.png'" :alt="data.Product" />
...
import { sales } from './gridchart/data-source';
...
import { loadAccumulationChartTheme, loadChartTheme } from './gridchart/grid-chart-theme-color';
...
export default defineComponent({
  ...
  methods: {
    ...
    created() {
      const grid = (this as any).$refs.gridInstance.$el.ej2_instances[0];
